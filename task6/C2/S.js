...
dom.querySelector("[id='6CY']").appendChild((new DOMParser()).parseFromString("Grafische Lösung noch nicht implementiert. \\(y="+resStr+"\\)", "text/html").getElementsByTagName('body')[0])
