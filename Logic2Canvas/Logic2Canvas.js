...
function generateLogic(inputVar, canvasVar, outputVar){
    ...
    function main(inp, can){
        ...
        // Redo
        var tempHighest = FRAMEHEIGHT - highestBoxY - /*padding.top +*/ padding.bottom;
        ...
        console.log('oX: '+offsetInitialX+'; oY: '+offsetInitialY);
        ...
        if(b){
            offsetInitialY = (FRAMEHEIGHT - (FRAMEHEIGHT - highestBoxY)) / 2;
        }else {
    ...
    function calcScaling(x=0, y=0){
        ...
        if(xScaling < yScaling){
            ...
            console.error('Nb: '+negationDotSize);
            ...
            console.error('Na: '+negationDotSize);
            console.log('Skalierung in x-Richtung');
            return true;
        }else {
            ...
            console.error('Nm: '+negationDotSize);
            if(negationDotSize < 2) negationDotSize = 2;
            if(negationDotSize > distBetweenX) negationDotSize = distBetweenX-2;
            console.error('Na: '+negationDotSize);
            console.log('Skalierung in y-Richtung');
            return false;
        }
        ...
        while(i < arr.length){
            ...
            if(arr[i] == '!'){ // Abfrage ob gesamter Block negiert
                ...
                if(Array.isArray(arr[i])){
                    ...
                    //console.error('Inps: '+amountInputsOnStage);
                    var boxFrom = {
    ...
    function drawInputs(){
        ...
        for(var i = 0; i < arr.length; i++){
            ...
            if(xScaling < yScaling) maxPos = FRAMEHEIGHT - highest;
            var yCord = FRAMEHEIGHT - padding.bottom - sizeBox.height - i * (sizeBox.height + ((maxPos - (arr.length * sizeBox.height)) / (arr.length - 1)));
