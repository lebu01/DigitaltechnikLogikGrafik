...
dom.querySelector("[id='6CY']").appendChild((new DOMParser()).parseFromString("<br><canvas class='Logic2Canvas' logic='"+rawExpr+"' solution='y' style='width:500px;height:255px;'></canvas>", "text/html").getElementsByTagName('body')[0])
